...
import { Undo as UndoIcon, Redo as RedoIcon, Sparkles, Check, Save, FileText, Download, ChevronDown, Share2, Send, Mail, Copy } from 'lucide-react';
              ...
              {showShareMenu && (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full text-start text-xs font-bold text-gray-700 dark:text-gray-300 hover:text-brown-600 dark:hover:text-brown-400 hover:bg-gray-50 dark:hover:bg-gray-700 px-3 py-2.5 rounded-lg flex items-center gap-2 transition-colors cursor-pointer"
                    type="button"
                  >
