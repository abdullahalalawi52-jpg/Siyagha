        ...
        <div className="flex items-center justify-between mb-10 pb-4 border-b border-gray-100 flex-wrap gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap justify-end">
            ...
            <button
              ...
              className="text-xs font-bold text-white bg-brown-600 hover:bg-brown-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1.5 px-3 py-2 rounded-xl shadow-sm transition-all cursor-pointer shrink-0"
            ...
            <button
              ...
              className="text-xs font-semibold flex items-center gap-1.5 px-3 py-2 rounded-xl shadow-sm glass-btn cursor-pointer shrink-0"
              type="button"
            >
            ...
            <a
              ...
              className={`text-xs font-semibold flex items-center gap-1.5 px-3 py-2 rounded-xl shadow-sm glass-btn shrink-0 ${
