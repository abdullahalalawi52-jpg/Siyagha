          ...
          >
            ...
            <div className="bg-white/40 dark:bg-black/20 p-6 sm:p-8 border-b border-gray-100 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-1">مكتبة القوالب</h3>
            ...
            {/* Tabs */}
            <div className="flex border-b border-gray-100 bg-gray-50/30 px-6 sm:px-8 shrink-0 gap-6">
              <button
